...
# Economic Parameters (Cost Minimization)
...
def set_scenario(scenario_id: int):
    """
    Configures the environment for the 5 mandatory scenarios.
    """
    global WORLD_STATE
